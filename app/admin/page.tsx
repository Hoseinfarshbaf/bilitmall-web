export default function AdminPage() {
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-5" dir="rtl">
      <section className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">ساخت و مدیریت رویدادهای مارکت‌پلیس</p>
            <a
              href="/admin/events"
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">خریداران ثبت‌نام‌شده در سایت</p>
            <a
              href="/admin/users"
              className="inline-block rounded-xl bg-blue-600 px-4 py-3 text-white"
            >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">بلیت‌ها و پرداخت‌های کاربران</p>
            <a
              href="/admin/orders"
              className="inline-block rounded-xl bg-blue-600 px-4 py-3 text-white"
            >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">تأیید حساب برگزارکنندگان</p>
            <a
              href="/admin/my-event"
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">تأیید رویدادهای ثبت‌شده توسط برگزارکنندگان</p>
            <a
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">درخواست‌های نمایش رویداد در مارکت‌پلیس</p>
            <a
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">افزودن، حذف و مشاهده شهرهای فعال در کل سیستم</p>
            <a
              href="/admin/cities"
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">تعریف سالن پیش‌فرض برای صندلی‌گذاری رویدادها</p>
            <a
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-slate-600">ورود برگزارکنندگان به پنل My Event</p>
            <a
              href="/my-event"
